...
import { countries, languages, sorts, categories } from "../../components/search/FilterForm"
...
export const formatParamsForApi = (params) => {
    const {
        category,
        country,
        dateFrom,
...
export const storeDataInSessionStorage = (key, value) => {
